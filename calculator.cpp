...
void Calculator::on_button_pos_neg_clicked()
{
    ...
    ui->results_display->insertPlainText(QString::number(m_savedNumber));
}
...
void Calculator::on_button_percent_clicked()
{
    m_currentOperation = Operation::Percentage;
    on_button_equals_clicked();
}
